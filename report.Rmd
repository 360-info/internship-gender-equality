...
poli <- gap %>%
  filter(
    indicator == "Global Gender Gap Political Empowerment subindex",
    subindicator_type == "Index"
  ) %>%
  select(country_name,
         "2021") %>%
...
econ <- gap %>%
  filter(
    indicator == "Global Gender Gap Economic Participation and Opportunity Subindex",
    subindicator_type == "Index"
  ) %>%
  select(country_name,
         "2021") %>%
...
econ$tooltip <-
  glue_data(
    ...
    "Country: {economy}",
    "\nWBL: {wbl_index}",
    "\nEconomic Participation Index: {economic_participation}"
  )
...
edu <- gap %>%
  filter(
    indicator == "Global Gender Gap Educational Attainment Subindex",
    subindicator_type == "Index"
  ) %>%
  select(country_name,
         "2021") %>%
...
edu$tooltip <-
  glue_data(
    ...
    "Country: {economy}",
    "\nWBL: {wbl_index}",
    "\nEducation Attainment Index: {education_attainment}"
  )
...
<div class = "center">
```{r poli, fig.cap="Association between WBL index and Political Empowerment index"}
ggplotly(
  poli %>%
    ...
    labs(
      x = "WBL index (2021)",
      y = "Political Empowerment index (2021)",
      color = NULL,
      shape = NULL,
      title = "Association between WBL index and Political Empowerment index"
    ),
  tooltip = "text"
) %>%
  layout(
...
ggplotly(
  econ  %>%
    ...
    labs(
      x = "WBL index (2021)",
      y = "Economic Participation index (2021)",
      color = NULL,
      shape = NULL,
      title = "Association between WBL index and Economic Participation index"
    ),
  tooltip = "text"
) %>%
  layout(
