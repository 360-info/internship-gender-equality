...
mob_df %>%
  ...
  labs(x = NULL,
       ...
       fill = "Year",
       title = "Percentage of countries in a region that have laws guaranteeing women's \nfreedom of movement")
```
...
work_df %>%
  ...
  labs(x = NULL,
       y = "Percentage of countries in a region",
       fill = "Year",
       title = "Percentage of countries in a region that have laws protecting women in workplace")
```

### Laws and emplyment and pay
```{R}
pay_df <- wbl_df %>%
  select("economy",
         "region",
...
pay_df %>%
  ...
  labs(x = NULL,
       y = "Percentage of countries in a region",
       fill = "Year",
       title = "Percentage of countries in a region that have laws for employment and pay")
```
...
marriage_df  %>%
  ...
  labs(x = NULL,
       y = "Percentage of countries in a region",
       fill = "Year",
       title = "Percentage of countries in a region that have laws protecting women in marriage")
```
...
parenthood_df  %>%
  ...
  labs(x = NULL,
       y = "Percentage of countries in a region",
       fill = "Year",
       title = "Percentage of countries in a region that have laws addressing parenthood")
```
