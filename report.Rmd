...
It is acknowledged that there are a number of limitations with this study. Our world is driven by data more than ever before, and missing data frequently leads to difficulties. The limitation of the data on discriminatory laws poses a challenge to better understand how gendered laws affect every aspect of a women's life. The WBL index only covers 8 topics, there are gendered laws in other areas such access to education, health and safety that affecting women's rights. Furthermore, most of the data for individual indicator in the WBL data set are categorical data, although the number of observations are large enough, the analysis is most likely low sensitivity, such as yes/no or good/bad. It is also very challenging to do quantitative analysis, only limited arithmetic operations can be performed.
