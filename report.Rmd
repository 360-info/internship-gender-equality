...
This analysis aims to identify the bias in the creation of laws which can disadvantage women - both socially and economically. The objective of the project is divided into three parts: to have a general understanding of the Women, Business and the law index; investigate the total number of law reforms enacted around the world and the trend of the score for individual law between 1971 to 2021; and to analyse the progress of each region on achieving legal quality in 9 different areas. The objective are achieved through:

1. Analysing the trend of the Women, Business and the Law index by region and at a country level between 1971 to 2021 and the association between the Women, Business and the Law index and the gender gap index.

2. Aggregating the response for each law measured by the WBL index to investigate the total number of law reforms across region and different indicators; analysing the trend of the score for each indicator by region and year.

3. Comparing the percentage of countries in each region that had laws to addressing women's freedom of movement, rights at workplace, pay, marriage, parenthood entrepreneurship, property rights, pension benefits in 1971 and 2021; the proportion of seats held by women in parliament in 1998 and 2021; the timeline of female suffrage in Somalia and Kuwait.
