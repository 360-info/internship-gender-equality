...
```{r wbl-shiny, fig.cap="The WBL index by countries and year", eval = TRUE}
...
<div class = "center">
```{r poli, fig.cap="Association between laws and women's political empowerment"}
ggplotly(
  poli %>%
    ...
    labs(
      ...
      color = NULL,
      shape = NULL,
      title = "Association between laws and women's political empowerment"
    ),
  tooltip = "text"
) %>%
  layout(
...
### Gendered laws and women's economic participation
...
```{r econ, fig.cap="Association between laws and women's economic participation"}
...
ggplotly(
  econ  %>%
    ...
    labs(
      ...
      color = NULL,
      shape = NULL,
      title = "Association between laws and women's economic participation"
    ),
  tooltip = "text"
) %>%
  layout(
