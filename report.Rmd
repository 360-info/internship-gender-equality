...
This analysis aims to identify the progress made on reducing bias in the creation of laws which can disadvantage women - both socially and economically between 1971 to 2021. Therefore, the objective of the project is divided into three parts: to have a general understanding of the Women, Business and the law index; investigate the total number of law reforms enacted around the world to achieve legal equality and the trend of the score for individual law between 1971 to 2021; and to further analyse the progress of each region on achieving legal quality in 9 different areas. The objectives are achieved through:

1.Part 1: analysing the trend of the Women, Business and the Law index that tracks how laws affect women's economic empowerment by region and at a country level between 1971 to 2021 and investigating the the relationship between the Women, Business and the Law index and the global gender gap index
