...
gap %>% 
  ...
  #           hjust = "centre",
  #           nudge_y = 0.035,
  #           check_overlap = TRUE) + #ggrepel!!!!
  geom_text_repel(data = flag_data,
                  aes(label = economy),
                  point.padding = 7) +
  # scale_x_continuous(limits = c(25, 100)) +
  scale_color_brewer(palette = "Set1") +
  ...
  theme(panel.grid.minor = element_blank(),
        axis.line.x = element_blank(
          # arrow = grid::arrow(length = unit(0.15, "cm"), ends = "last", type = "closed")
          ),
        ...
        legend.box.margin = margin(-0.5, 0, 0, -3, "cm"),
  ...
  annotate_360_glasslight(x = 30, y = 0.329, label = "**More**", size = 4) +
  annotate_360_glasslight(x = 98, y = 0.329, label = "**Less**", size = 4) +
  annotate_360_glasslight(x = 25, y = 0.88, label = "**More**", size = 4) +
  annotate_360_glasslight(x = 25, y = 0.38, label = "**Less**", size = 4) +
  labs(x = "National laws which discriminate against women",
       # y = "More \n\n\n\n\n\n Gender equality \n Access to resources \n and opportunities \n\n\n\n\n Less",
       y = "Gender equality \n Access to resources \n and opportunities",
       color = NULL,
       title = "Scatter plot of WBL index and gender gap index",
