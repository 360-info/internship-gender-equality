...
gap %>% 
  ...
  theme_light() +
  # theme(axis.line.x = element_line(arrow = arrow(length = unit(0.3, "cm"), ends = "both")) +
  labs(x = "WBL index",
       y = "Gender gap index",
       color = NULL,
...
tooltip = "text"
  ...
  layout(xaxis = list(title = list(font = list(size = 10),
                                   standoff = 10)),
         yaxis = list(title = list(font = list(size = 10),
                                   stabdoff = 10)),
         legend = list(orientation = "h",
                       font = list(size = 8))) %>% 
