...
## indicators <- read.csv(here("data/API_17_DS2_en_csv_v2_3371618.csv"), skip = 4) old version
gender <- read.csv(here("data/API_17_DS2_en_csv_v2_4040307/API_17_DS2_en_csv_v2_4040307.csv"), skip = 4)  # updated version
```
...
girafe(code = print(iraph_plot)) %>%
  saveWidget("test.html")


# x <- girafe(ggobj = iraph_plot)
