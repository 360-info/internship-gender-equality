...
```{r}
options(themes360info.loadfonts = TRUE)
...
gap %>% 
  ...
  coord_cartesian(ylim = c(0.4, 0.9),
                  clip = "off") +
  annotate_360(text_colour = "light", x = 28, y = 0.329, label = "More Laws", size = 3) +
  annotate_360(text_colour = "light", x = 98, y = 0.329, label = "Less Laws", size = 3) +
  theme_360() +
