...
gap %>% 
  ...
  annotate(geom = "text", x = 20, y = 0.45, label = "Less", size = 3) +
  # annotate_360(text_colour = "light", x = 28, y = 0.329, label = "More", size = 3) +
  # annotate_360(text_colour = "light", x = 98, y = 0.329, label = "Less", size = 3) +
...
# save_360plot(myplot, "figures/gender.png")
