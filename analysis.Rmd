...
gap %>% 
  ...
  geom_point(aes(color = Region),
             alpha = 0.7) +
  annotate("text", x = 26.9, y = 0.48, label = "Yeman, Rep", size = 2) +
  annotate("text", x = 38.1, y = 0.46, label = "Afghanistan", size = 2) +
  annotate("text", x = 100, y = 0.91, label = "Iceland", size = 2) +
  annotate("text", x = 97.5, y = 0.875, label = "Finland", size = 2) +
  
    # geom_flag(aes(country = code)) +
  scale_x_continuous(limits = c(25, 100)) +
  scale_color_brewer(palette = "Set1") +
  stat_cor(aes(label = ..r.label..)) +
  theme(axis.line.x = element_line(arrow = grid::arrow(length = unit(0.3, "cm"), ends = "both", type = "closed"))) +
  theme_light() +
  labs(x = "less law",
       y = "More equality",
       title = "Scatter plot of WBL index and gender gap index",
...
gap %>% 
  ...
  select(code,
         ...
         gender_gap_index) %>% 
  filter(!is.na(gender_gap_index),
         economy %in% c("Iceland", "United Kingdom", "United States","Mauritius",
                        "Serbia", "Nepal", "China", "Namibia", "Rwanda", "Turkey",
                        "Saudi Arabia", "Dominican Republic", "Congo", "Jamaica",
  ...
  annotate(geom = "text", x = 28, y = 0.32, label = "More Laws", size = 3) +
  annotate(geom = "text", x = 98, y = 0.32, label = "Less Laws", size = 3) +
  coord_cartesian(ylim = c(0.4, 1), # This focuses the y-axis on the range of interest
                      clip = 'off') +
  labs(x = "",
       y = "More equality\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nLess equality",
       title = "Scatter plot of WBL index and gender gap index",
