...
gap %>% 
  ...
  annotate_360_glasslight(x = 28, y = 0.329, label = "More", size = 3) +
  annotate_360_glasslight(x = 98, y = 0.329, label = "Less", size = 3) +
  annotate_360_glasslight(x = 25, y = 0.85, label = "More", size = 3) +
  annotate_360_glasslight(x = 25, y = 0.38, label = "Less", size = 3) +
